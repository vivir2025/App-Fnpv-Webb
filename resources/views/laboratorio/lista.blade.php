                                        ...
                                        <tr data-fecha="{{ $envio['fecha'] ?? '' }}" data-envio-id="{{ $envio['id'] }}">
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm me-1 btn-enviar-correo 
                                                        {{ $enviadoPorCorreo ? 'btn-outline-primary' : 'btn-primary' }}" 
                                                        title="{{ $enviadoPorCorreo ? 'Reenviar por email' : 'Enviar por email' }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function enviarPorCorreo(envioId, boton) {
        ...
        // Usar fetch con método GET y parámetro para actualizar el estado
        fetch(`{{ url('laboratorio/enviar-email') }}/${envioId}?actualizar_estado=1`, {
            method: 'GET',
            headers: {
